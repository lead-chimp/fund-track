            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                            ...
                            <span
                                className={`px-3 py-1 rounded-full text-sm font-medium ${status === "authenticated"
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border border-gray-200 rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600 mb-3">
                                Uses <code className="bg-gray-100 px-2 py-1 rounded">signOut(&#123; redirect: false &#125;)</code> then manually redirects
                            </p>
                            <button
                        ...
                        <div className="border border-gray-200 rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600 mb-3">
                                Calls server action that runs <code className="bg-gray-100 px-2 py-1 rounded">signOut()</code> server-side
                            </p>
                            <button
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm h-64 overflow-y-auto">
                        {log.length === 0 ? (
                            <p className="text-gray-500">No logs yet. Try a signout method above.</p>
                        ) : (
                            log.map((entry, index) => (
