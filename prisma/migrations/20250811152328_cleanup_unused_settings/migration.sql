/*
  ...
  - The values [lead_management] on the enum `system_setting_category` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."system_setting_category_new" AS ENUM ('notifications');
